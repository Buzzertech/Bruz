...
public class FragmentFour extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        TextView easydesc1 = (TextView) getActivity().findViewById(R.id.easy_desc);
        TextView easydesc2 = (TextView) getActivity().findViewById(R.id.easy_desc2);
        easydesc1.setTypeface(typeface);
        easydesc2.setTypeface(typeface);
